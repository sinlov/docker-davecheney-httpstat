...
INFO_BUILD_DOCKER_IMAGE_NAME ?= sinlov/docker-davecheney-httpstat
INFO_BUILD_DOCKER_FILE = Dockerfile
INFO_BUILD_FROM_IMAGE ?= alpine:latest

INFO_TEST_BUILD_PATH ?= test
INFO_TEST_BUILD_DOCKER_FILE ?= Dockerfile
INFO_TEST_BUILD_PARENT_IMAGE ?= golang:1.19.2-buster
INFO_TEST_BUILD_PARENT_CONTAINER ?= test-parent-docker-davecheney-httpstat
